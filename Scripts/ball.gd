extends RigidBody2D # extends allows to open in Navigator / Inspector?

# SIGNALING : If I want to send a message to another node
#				but I don't want to find it in tree.
